...
var DiffViewer = /** @class */ (function (_super) {
    ...
    function DiffViewer(props) {
         ...
         */
        _this.onBlockClickProxy = function (id) { return function () { return _this.onBlockExpand(id); }; };
        /**
        ...
        _this.renderSkippedLineIndicator = function (num, blockNumber, leftBlockLineNumber, rightBlockLineNumber) {
            var _a;
            var splitView = _this.props.splitView;
            ...
            return (React.createElement("tr", { key: Math.round(100).toString(), className: _this.styles.codeFold },
                !_this.props.hideLineNumbers && (React.createElement("td", { className: _this.styles.codeFoldGutter })),
                React.createElement("td", { className: classnames_1.default((_a = {}, _a[_this.styles.codeFoldGutter] = !splitView, _a)) }),
        ...
        _this.renderDiff = function () {
            ...
            var _b = compute_lines_1.computeLineInformation(oldValue, newValue, _this.props.disableWordDiff), lineInformation = _b.lineInformation, diffLines = _b.diffLines;
        ...
        _this.render = function () {
            var _a = _this.props, oldValue = _a.oldValue, newValue = _a.newValue;
            if (typeof oldValue !== 'string' || typeof newValue !== 'string') {
                throw Error('"oldValue" and "newValue" should be strings');
            }
            _this.styles = _this.computeStyles(_this.props.styles);
            var nodes = _this.renderDiff();
            return (React.createElement("table", { className: _this.styles.diffContainer },
